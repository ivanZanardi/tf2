...
int main()
{
  ...
  pycomet::csv::write("./data.csv", a);

  // Test cases: all the output data
  // files should be the same as 'data.csv'
  // ----------------------------------
  // Test 1: read and write the matrix
  auto a1 = pycomet::csv::read<int>("./data.csv");
  pycomet::csv::write("./data.T1.csv", a1);

  // Test 2.a: flatten and write the matrix (row-major)
  auto v1 = pycomet::ops::flatten(a, false);
  pycomet::csv::write("./data.T2.a.csv", v1, shape, true);

  // Test 2.b: flatten and write the matrix (column-major)
  auto v2 = pycomet::ops::flatten(a, true);
  pycomet::csv::write("./data.T2.b.csv", v2, shape, false);

  // Test 3.a: flatten, reshape and write the matrix (row-major)
  auto r1 = pycomet::ops::reshape(v1, shape, false);
  pycomet::csv::write("./data.T3.a.csv", r1);

  // Test 3.b: flatten, reshape and write the matrix (column-major)
  auto r2 = pycomet::ops::reshape(v2, shape, true);
  pycomet::csv::write("./data.T3.b.csv", r2);
